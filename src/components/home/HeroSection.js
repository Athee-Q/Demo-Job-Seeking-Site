  ...
  return (
    <section className="relative flex items-center justify-center min-h-[80vh] p-6 md:p-8 lg:p-10 overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center text-center text-white">
        ...
        >
          Discover Your Perfect Career Match with TalentHive
        </motion.h1>
        <motion.p
        ...
        >
          ...
          unlock your potential and find the role you&apos;ve been searching for.
        </motion.p>
        ...
        >
          <input
            ...
            className="w-full border border-gray-500 bg-(--color-primary)/30  bg-opacity-70 p-3 rounded-md text-accent font-semibold focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)]"
          />
          <div className="flex gap-4 flex-wrap justify-center">
            ...
            <Link href="/auth/register">
              <button className="px-6 py-3 border-2 border-[var(--color-primary)] dark:border-[var(--color-dark-primary)] text-(--color-primary) dark:text-(--color-dark-primary) hover:bg-(--color-primary)/30 cursor-pointer font-bold rounded-lg text-lg hover:opacity-90 transition">
                Get Started
              </button>
            </Link>
          </div>
