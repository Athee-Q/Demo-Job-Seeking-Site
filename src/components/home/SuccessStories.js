...
const testimonials = [
  {
    quote:
      "TalentHive made my job search so much easier! I found my dream role within weeks. The personalized recommendations were spot on.",
    name: "Priya S.",
    title: "Product Designer",
  },
  {
    quote:
      "As a recent graduate, TalentHive provided me with the resources and opportunities I needed to kickstart my career. Highly recommend!",
    name: "Arjun K.",
