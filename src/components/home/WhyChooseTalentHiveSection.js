// components/home/WhyChooseTalentHiveSection.tsx
"use client";
...
export default function WhyChooseTalentHiveSection() {
  return (
    <section className="p-6 md:p-8 lg:p-10 bg-secondary dark:bg-dark-secondary text-text dark:text-dark-text">
      <div className="w-11/12 mx-auto text-center mb-12">
        ...
        >
          Why TalentHive? Your Partner in Career Success
        </motion.h2>
        <p className="text-lg">
          At TalentHive, we go beyond job listings &ndash; we empower your entire career journey.
        </p>
      </div>
